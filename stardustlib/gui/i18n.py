...
_KO: dict[str, str] = {
    ...
    # 업로드 다이얼로그
    "upload_dlg_title": "파일 업로드",
    "upload_dlg_to": "업로드 위치: {path}",
    "upload_add": "파일 추가",
    "upload_remove": "선택 제거",
    "upload_start": "올리기",
    "upload_cancel": "취소",
    "upload_close": "닫기",
    "upload_none": "선택된 파일이 없습니다.",
    "upload_log_start": "업로드 시작: {name}",
    "upload_log_done": "완료: {name} ({size})",
    "upload_log_fail": "실패: {name} — {msg}",
    "upload_log_exists": "건너뜀(이미 존재, 덮어쓰지 않음): {name}",
    "upload_log_all": "전체 완료: 성공 {ok} / 실패 {fail} / 건너뜀 {skip}",
    "upload_log_cancel": "취소됨 (남은 {n}개 건너뜀)",
...
_EN: dict[str, str] = {
    ...
    "upload_dlg_title": "Upload Files",
    "upload_dlg_to": "Destination: {path}",
    "upload_add": "Add Files",
    "upload_remove": "Remove Selected",
    "upload_start": "Upload",
    "upload_cancel": "Cancel",
    "upload_close": "Close",
    "upload_none": "No files selected.",
    "upload_log_start": "Starting: {name}",
    "upload_log_done": "Done: {name} ({size})",
    "upload_log_fail": "Failed: {name} — {msg}",
    "upload_log_exists": "Skipped (already exists, not overwritten): {name}",
    "upload_log_all": "All done: {ok} succeeded, {fail} failed, {skip} skipped",
    "upload_log_cancel": "Cancelled ({n} remaining skipped)",
